...
HACS shows an automatically generated placeholder until the brand is accepted
into [home-assistant/brands](https://github.com/home-assistant/brands) — icons are
never read out of a custom repository. The artwork and the submission steps are in
[brand/](brand/), generated by `brand/gen_icon.py`.
